...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
                model_name='aktrack',
                name='color',
                field=models.CharField(blank=True, help_text='Color for displaying', max_length=7,
                                       verbose_name='Color'),
        ),
        migrations.AlterField(
                model_name='aktype',
        ...
        migrations.AlterField(
                model_name='room',
                name='building',
                field=models.CharField(help_text='Name/number of the building', max_length=256,

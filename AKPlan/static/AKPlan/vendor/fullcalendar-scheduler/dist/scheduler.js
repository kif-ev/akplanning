...
(function (factory) {
    ...
    var COL_MIN_WIDTH, Calendar, CalendarExtension, Class, CoordCache, DEFAULT_GRID_DURATION, DragListener, Emitter,
        EventRow, FC, Grid, HRowGroup, LICENSE_INFO_URL, MAX_AUTO_CELLS, MAX_AUTO_SLOTS_PER_LABEL, MAX_CELLS,
        MIN_AUTO_LABELS, PRESET_LICENSE_KEYS, RELEASE_DATE, ResourceAgendaView, ResourceBasicView, ResourceDayGrid,
        ResourceDayTableMixin, ResourceGrid, ResourceManager, ResourceMonthView, ResourceRow, ResourceTimeGrid,
        ResourceTimelineGrid, ResourceTimelineView, ResourceView, RowGroup, RowParent, STOCK_SUB_DURATIONS,
        ScrollFollower, ScrollFollowerSprite, ScrollJoiner, Scroller, Spreadsheet, TimelineGrid, TimelineView,
        UPGRADE_WINDOW, VRowGroup, View, applyAll, capitaliseFirstLetter, compareByFieldSpecs, computeIntervalUnit,
        computeOffsetForSeg, computeOffsetForSegs, copyRect, cssToStr, debounce, detectRtlScrollSystem,
        detectWarningInContainer, divideDurationByDuration, divideRangeByDuration, durationHasTime, flexibleCompare,
        getOwnCells, getRectHeight, getRectWidth, getScrollFromLeft, getScrollbarWidths, hContainRect, hasAnyScrollbars,
        htmlEscape, intersectRanges, intersectRects, isImmuneUrl, isInt, isValidKey, joinRects, multiplyDuration,
        normalizedHScroll, origDisplayEvents, origDisplayView, origGetSegClasses, origRenderSkeleton,
        origUnrenderSkeleton, parseFieldSpecs, processLicenseKey, proxy, renderingWarningInContainer, rtlScrollSystem,
   ...
   */
    ...
    CalendarExtension = (function (superClass) {
        ...
        CalendarExtension.prototype.getPeerEvents = function (span, event) {
            var filteredPeerEvents, isPeer, j, k, l, len, len1, len2, newResourceId, newResourceIds, peerEvent,
                peerEvents, peerResourceId, peerResourceIds;
    ...
    Grid.prototype.getSegSkinCss = function (seg) {
        var event, eventColor, getResourceBackgroundColor, getResourceBorderColor, getResourceTextColor, optionColor,
            resources, source, sourceColor, view;
        view = this.view;
        event = seg.event;
        source = event.source || {};
 ...
 */
   ...
   */
        ...
        TimelineGrid.prototype.queryHit = function (leftOffset, topOffset) {
            var containerCoordCache, localSnapIndex, partial, slatCoordCache, slatIndex, slatLeft, slatRight, slatWidth,
                snapIndex, snapLeft, snapRight, snapsPerSlot;
        ...
        TimelineGrid.prototype.renderHeadHtml = function () {
            var cell, cellRows, date, dateData, format, formats, html, i, isChrono, isLast, isSuperRow, isWeekStart, j,
                k, l, labelInterval, leadingCell, len, len1, len2, len3, len4, len5, len6, m, n, newCell, p,
                prevWeekNumber, q, row, rowCells, slatHtml, slotCells, slotDates, text, weekNumber;
        ...
        TimelineGrid.prototype.renderFgSegsInContainers = function (pairs) {
            var container, coords, j, k, l, len, len1, len2, len3, len4, len5, len6, len7, m, n, p, q, r, ref, ref1,
                ref2, ref3, results, seg, segs;
        ...
        TimelineGrid.prototype.renderHelperSegsInContainers = function (pairs, sourceSeg) {
            var containerObj, coords, helperContainerEl, helperNodes, j, k, l, len, len1, len2, len3, m, ref, ref1,
                ref2, seg, segs;
            helperNodes = [];
            for (j = 0, len = pairs.length; j < len; j++) {
